...
import com.lqr.videoimpl.VideoCompress;
...
public class BaseVideoCompressActivity extends Activity implements View.OnClickListener {
    private static final String TAG = "BaseVideoCompressActivity";
    ...
    private void setPicture(){
        ...
        PictureSelector.create(BaseVideoCompressActivity.this)
...
private void openFile(File file) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(BaseVideoCompressActivity.this, "不能打开视频文件", Toast.LENGTH_SHORT).show();
        }
